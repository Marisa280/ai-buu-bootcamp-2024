...
ACCESS_TOKEN = os.getenv("ACCESS_TOKEN", "ud0363aAZ8XrxzQ/Mgm+L0Zd5vVocJEpfwzCFcOEL6xKVrq8wT92t2N6+UG+fnyDi7c/HAtbNnk0h7Y/kAc3oPDmgU8vRH5omsImxxCYXsLB9nHuOqImifDHpWyJiXdFqvPXxJHdEpBIBL+ySRioywdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("CHANNEL_SECRET", "18861960dc2febf9eb3bd3ad03d6fb5c")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyB4ifa1wad825MlwFWuogtll2_sEbxSjlk")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        ...
        "สมาชิก Clicknext แผนก AI พี่ดาว - BA พี่ออย - BA พี่ปาล์ม - back-end developer พี่ชวน - PM พี่เจ๋ง - front-end  developer"
    ]
